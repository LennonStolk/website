...
<body style="font-family: Arial, Helvetica, sans-serif;" class="centeredBody">
    <?php include "includes/navbar.php" ?>
    <h1 class="mainTitle">Mijn portfolio</h1>
    <div class="projectsFlexbox">
        ...
        <div class="projectBlock">
            <img src="img/project_thumbnails/casino.png" alt="Plaatje niet aanwezig" height="200px">
            <a href="projects/casino">
                <div class="projectTitle">Casino</div>
            </a>
        </div>
    </div>
</body>
